...
{
  trace_puts("Chuong trinh tan nhiet tu dong!");
  trace_puts("Nhiet do > 35 bat tan nhiet, Nhiet do < 35 tat tan nhiet!");
  ...
  while (1)
    {
      ...
      if (temperature[seconds % 5] > 30) {
        ...
        trace_puts("BAT DAU TAN NHIET, LED XANH BAT!");
      } else {
        blink_led_off(); // Turn off the LED
        trace_puts("TAT TAN NHIET, LED XANH TAT!");
      }
    }
}
